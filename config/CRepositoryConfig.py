...
from GenPackageDoc.version import __version__     # ! here wee need the package name hard coded !
from GenPackageDoc.version import __versiondate__ # ! here wee need the package name hard coded !
...
class CRepositoryConfig():
    ...
    def __init__(self, sCalledBy=None):
        ...
        self.__dictRepositoryConfig['PACKAGE_DATA'] = package_data.get("GenPackageDoc", {})
